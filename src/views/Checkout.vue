          ...
          <div class="row">
            <div class="col-lg-7 pb-0 pb-md-7">
              <form @submit.prevent="createOrder">
                <div class="bg-primary text-primary-200 py-5 px-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-lg">
                      <input type="email"
                      class="form-control form-control-lg bg-primary-200 border-right-0"
                      name="email" id="email"
                      v-validate="'required|email'"
                      v-model="form.user.email" placeholder="example@email.com">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg bg-primary-200"
                    name="name" id="username" :class="{'is-invalid': errors.has('name')}"
                    v-model="form.user.name"
                    v-validate="'required'" placeholder="王小明">
                    <span class="text-danger" v-if="errors.has('name')">姓名欄位不得留空</span>
                  </div>
                  <div class="form-group">
                    <label class="h4" for="tel">電話</label>
                    <input type="tel" class="form-control form-control-lg bg-primary-200"
                    name="tel" id="tel"
                    v-model="form.user.tel"
                    v-validate="'required'" placeholder="0912-345-678">
                  ...
                  <div class="form-group">
                    ...
                    v-validate="'required'" placeholder="幸福路 520 號">
                ...
                <button type="submit" class="btn btn-minor btn-block btn-xl
                text-primary font-weight-bold py-3">下一步</button>
              </form>
            </div>

            <div class="col-lg-5 d-none d-lg-block">
              <div class="card border-primary-200 mb-3">
                <h2 class="h4 card-header bg-primary-200 border-primary-200
                text-primary-100 text-center font-weight-bold">訂單摘要</h2>
              ...
              <div class="card border-primary-200" >
                <h2 class="h4 card-header bg-primary-200 border-primary-200
                text-primary-100 text-center font-weight-bold">購物清單</h2>
                <div class="card-body pt-0 cart">
                  <div class="d-flex mt-3" v-for="item in cart.carts" :key="item.id">
                    <div class="cart-image cart-image-sm mr-3"
