<template>
  <div>
    ...
    <div class="text-right mt-4">
      ...
      @click="openModal(true)" data-backdrop="static">建立新的產品</button>
    </div>
        ...
        <tr v-for="(item) in products" :key="item.id">
          ...
          <td>
            <div class="btn-group">
              ...
              @click="openModal(false, item)" data-backdrop="static">編輯</button>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <div class="form-row">
                  ...
                  <input type="text" class="form-control" id="title"
                  v-model="tempProduct.category" placeholder="請輸入標題">
